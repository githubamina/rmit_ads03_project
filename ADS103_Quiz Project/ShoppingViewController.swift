...
class ShoppingViewController: UIViewController {
    ...
    //Outlets to ShoppingViewController's views, buttons, labels, switches and sliders
    ...
    //Variable to store unshuffled Shopping Quiz questions
    var questions = shoppingQuestions
    
    //Variable to store array of shuffled Shopping Quiz questions
    ...
    @IBAction func multipleAnswerButtonPressed() {
        //let currentAnswers = shuffleAnswers(answerArray: currentQuestions[questionIndex].answers)
    ...
    @IBAction func rangedAnswerButtonPressed() {
        //let currentAnswers = currentQuestions[questionIndex].answers
    ...
    func nextQuestion() {
        ...
        if questionIndex < questions.count {
            ...
            performSegue(withIdentifier: "ShoppingResultsSegue", sender: nil)
        }
    }
    ...
    override func prepare (for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ShoppingResultsSegue" {
