...
class EntertainmentViewController: UIViewController {
    ...
    //Variable to store unshuffled Entertainment Quiz questions
    var questions = entertainmentQuestions
    
    //Variable to store array of shuffled Entertainment Quiz questions
    ...
    func nextQuestion() {
        ...
        if questionIndex < questions.count {
            ...
            performSegue(withIdentifier: "EntertainmentResultsSegue", sender: nil)
        }
    }
    ...
    override func prepare (for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "EntertainmentResultsSegue" {
